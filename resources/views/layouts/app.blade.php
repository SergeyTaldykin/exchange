...
<html lang="en">
  <head>
    <title>Exchange &mdash; @yield('title')</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="/" class="h2 mb-0">Banker<span class="text-primary">.</span> </a></h1>
          </div>
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li class="social"><a href="#contact-section" class="nav-link"><span class="icon-linkedin"></span></a></li>
                  ...
                  @if (\Illuminate\Support\Facades\Auth::guest())
                      <li class="social"><a href="{{ route('login') }}" class="nav-link"><span class="icon-sign-in"></span></a></li>
                  @else
                    <li class="social"><a href="{{ route('profile.index') }}" class="nav-link"><span class="icon-settings"></span></a></li>
                    <li class="social"><a href="{{ route('logout') }}" class="nav-link"><span class="icon-sign-out"></span></a></li>
                  @endif
              </ul>
            </nav>
          </div>
  ...
  <script src="{{ asset('storage/js/jquery.countdown.min.js') }}"></script>
  ...
  <script src="{{ asset('storage/js/isotope.pkgd.min.js') }}"></script>
